...
const std::vector<Vertex> vertices {
    ...
    {{-0.5f, 0.5f, 0.0f}, {1.0f, 0.5f, 0.7f}, {0.0f, 1.0f}},
    {{0.5f, 0.5f, 0.0f}, {1.0f, 0.5f, 0.5f}, {1.0f, 1.0f}},
    {{0.5f, -0.5f, 0.0f}, {1.0f, 0.5f, 0.7f}, {1.0f, 0.0f}},

    {{-0.5f, -0.5f, -0.5f}, {1.0f, 0.5f, 0.5f}, {0.0f, 0.0f}},
    {{-0.5f, 0.5f, -0.5f}, {1.0f, 0.5f, 0.7f}, {0.0f, 1.0f}},
    {{0.5f, 0.5f, -0.5f}, {1.0f, 0.5f, 0.5f}, {1.0f, 1.0f}},
    {{0.5f, -0.5f, -0.5f}, {1.0f, 0.5f, 0.7f}, {1.0f, 0.0f}},
};
    ...
    void transitionImageLayout(VkImage image, VkFormat format,
        ...
        if (newLayout == VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL) {
            ...
            if (format == VK_FORMAT_D32_SFLOAT_S8_UINT
                || format == VK_FORMAT_D24_UNORM_S8_UINT) { // has stencil comp
